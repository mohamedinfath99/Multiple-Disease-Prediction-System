                        ...
                        <div>
                            ...
                            <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
                                ...
                                <div>
                                    ...
                                    <p className='text__para'>Number of Doctors on Staff</p>
                                </div>
            ...
            <section>
                <div className='container'>
                    <div className='lg:w-[470px] mx-auto'>
                        ...
                        <p className='text__para text-center'>"Delivering unparalleled, world-class healthcare to all is our commitment."</p>
                    </div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
                        <div className='py-[30px] px-5'>
                            ...
                            <div className='mt-[30px]'>
                                ...
                                <p className='text-[16px] leading-7  text-headingColor font-[400] text-center'>"Find expert doctors here."</p>
                        ...
                        <div className='py-[30px] px-5'>
                            ...
                            <div className='mt-[30px]'>
                                <h2 className='text-[26px] leading-9 text-headingColor font-[700] text-center'>Find a Services</h2>
                                <p className='text-[16px] leading-7  text-headingColor font-[400] text-center'>"Explore our comprehensive healthcare offerings."</p>
                        ...
                        <div className='py-[30px] px-5'>
                            ...
                            <div className='mt-[30px]'>
                                <h2 className='text-[26px] leading-9 text-headingColor font-[700] text-center'>Find a Contact</h2>
                                <p className='text-[16px] leading-7  text-headingColor font-[400] text-center'>"Get in touch with us for assistance."</p>
            ...
            <section >
                <div className='container'>
                    <div className='xl:w-[470px] mx-auto'>
                        ...
                        <p className='text__para text-center'>"Our exceptional doctors provide world-class healthcare, delivering unmatched expertise and care to all"</p>
                    </div>
